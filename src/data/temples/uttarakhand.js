export const uttarakhandTemples = [
      ...
      "sources": [
        {
          ...
          "url": "https://en.wikipedia.org/wiki/Bagnath_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "A group of ancient temples on the Gomti banks, built by the Katyuri kings.",
    "highlight": "Beautiful temple complex.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Baijnath_Temple_complex.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "Feeding fish in Gomti is popular.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "12th century Katyuri.",
      "architecture": "Nagara style.",
      "visitorNotes": "Serene atmosphere.",
      "sources": [
        {
          "label": "Baijnath",
          "url": "https://en.wikipedia.org/wiki/Baijnath,_Uttarakhand",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "story": "The oldest and largest temple in the Jageshwar group, dedicated to the conqueror of death.",
    "highlight": "Unique linga worship.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Mahamrityunjaya_Temple_Jageshwar.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      ...
      "architecture": "Nagara style.",
      "visitorNotes": "Chant the mantra here.",
      "sources": [
        {
          "label": "Jageshwar",
          "url": "https://en.wikipedia.org/wiki/Jageshwar",
  ...
  },
  {
    ...
    "moreDetails": {
      ...
      "sources": [
        {
          "label": "Tapkeshwar",
          "url": "https://en.wikipedia.org/wiki/Tapkeshwar_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
      ...
      "sources": [
        {
          ...
          "url": "https://en.wikipedia.org/wiki/Neelkanth_Mahadev_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
      ...
      "sources": [
        {
          ...
          "url": "https://en.wikipedia.org/wiki/Daksha_Mahadev_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "story": "The venue of the celestial wedding of Lord Shiva and Goddess Parvati, witnessed by Vishnu.",
    "highlight": "Akhand Dhuni (Eternal Flame).",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Triyuginarayan_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "Popular wedding destination.",
    "rituals": [
      "Marriage vows"
    ],
    "festivals": [
      "Shivratri, Vivah Panchami"
    ],
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Nagara.",
      "visitorNotes": "Add wood to the eternal fire.",
      "sources": [
        {
  ...
  },
  {
    ...
    "story": "Dedicated to Kartikeya (Shiva's son) offering his bones to his father; famous for 360-degree Himalayan views.",
    "highlight": "Spectacular sunrise/sunset views.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Kartik_Swami_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "entryNotes": "3 km trek from Kanakchauri.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Carry water for trek.",
      "sources": [
        {
          "label": "Kartik Swami",
          "url": "https://en.wikipedia.org/wiki/Kartik_Swami",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  {
    "name": "Bindeshwar Mahadev Temple",
    "state": "Uttarakhand",
    "city": "Bindukhatta",
    ...
    "moreDetails": {
      "history": "Local origins.",
      "architecture": "Simple.",
      "visitorNotes": "Peaceful retreat.",
      "sources": [
        {
          "label": "Bindukhatta",
          "url": "https://en.wikipedia.org/wiki/Bindukhatta",
          "type": "Encyclopedia"
        }
      ]
    }
      ...
      "sources": [
        {
          ...
          "url": "https://en.wikipedia.org/wiki/Someshwar,_Uttarakhand",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "Nestled in a thick deodar forest with a natural stream, built by King Pithu.",
    "highlight": "Forest solitude.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Binsar_Mahadev_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "Near Ranikhet (Not Binsar Sanctuary).",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Ideal for meditation.",
      "sources": [
        {
  ...
  },
  {
    ...
    "story": "Famous temple of Golu Devta, an incarnation of Shiva (Gaur Bhairav), known as the God of Justice.",
    "highlight": "Thousands of bells offered by devotees.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Chitai_Golu_Devta_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "Petitions written on paper.",
    "rituals": [
      "Bell offering"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "Chand dynasty legend.",
      "architecture": "Kumaoni style.",
      "visitorNotes": "Read the petitions (respectfully).",
      "sources": [
        {
          "label": "Golu Devta",
          "url": "https://en.wikipedia.org/wiki/Golu_Devta",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  {
    "name": "Ghorakhal Golu Devta Temple",
    "state": "Uttarakhand",
    "city": "Bhowali",
    "region": "Nainital district",
    "tags": [
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Popular tourist stop.",
      "sources": [
        {
          "label": "Ghorakhal",
          "url": "https://en.wikipedia.org/wiki/Ghorakhal",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      ...
      "sources": [
        {
          "label": "Kashipur",
          "url": "https://en.wikipedia.org/wiki/Kashipur,_Uttarakhand",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  {
    "name": "Bhimshankar Mahadev Temple",
    "state": "Uttarakhand",
    "city": "Kashipur",
    "region": "Udham Singh Nagar district",
    "tags": [
    ...
    "moreDetails": {
      "history": "Mythological link.",
      "architecture": "Modern.",
      "visitorNotes": "Pilgrimage center.",
      "sources": [
        {
          "label": "Kashipur",
          "url": "https://en.wikipedia.org/wiki/Kashipur,_Uttarakhand",
  ...
  },
  {
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Sunrise spot.",
      "sources": [
        {
          "label": "Pauri",
          "url": "https://en.wikipedia.org/wiki/Pauri",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Perfect for nature lovers.",
      "sources": [
        {
          "label": "Lansdowne",
          "url": "https://en.wikipedia.org/wiki/Lansdowne,_India",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "Dedicated to Kandoliya Devta (Shiva form), the guardian deity of Pauri.",
    "highlight": "Views of Gangwara and Himalayas.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Kandoliya_Temple_Pauri.jpg",
    "credit": "Wikimedia Commons",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Hill style.",
      "visitorNotes": "Adventure spiritualism.",
      "sources": [
        {
          "label": "Pithoragarh",
          "url": "https://en.wikipedia.org/wiki/Pithoragarh",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Skanda Purana reference.",
      "architecture": "Stone.",
  ...
  },
  {
    ...
    "moreDetails": {
      ...
      "architecture": "Nagara (Khajuraho influence).",
      "visitorNotes": "Historic interest.",
      "sources": [
        {
          "label": "Pithoragarh",
          "url": "https://en.wikipedia.org/wiki/Pithoragarh",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Pandava legend.",
      "architecture": "Simple.",
      "visitorNotes": "Religious significance.",
      "sources": [
        {
          "label": "Pithoragarh",
          "url": "https://en.wikipedia.org/wiki/Pithoragarh",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient Naga cult.",
      "architecture": "Local style.",
      "visitorNotes": "Great views.",
      "sources": [
        {
          "label": "Berinag",
          "url": "https://en.wikipedia.org/wiki/Berinag",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Hill shrine.",
      "visitorNotes": "Part of Nag circuit.",
      "sources": [
        {
          "label": "Bageshwar",
          "url": "https://en.wikipedia.org/wiki/Bageshwar",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Simple.",
      "visitorNotes": "Explore local culture.",
      "sources": [
        {
          "label": "Pithoragarh",
          "url": "https://en.wikipedia.org/wiki/Pithoragarh",
  ...
  },
  {
    ...
    "moreDetails": {
      ...
      "sources": [
        {
          "label": "Champawat",
          "url": "https://en.wikipedia.org/wiki/Champawat",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Local legend.",
      "architecture": "Simple.",
      "visitorNotes": "Listen to the Jaggar.",
      "sources": [
        {
          "label": "Almora",
          "url": "https://en.wikipedia.org/wiki/Almora",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "story": "Associated with Sage Kapila, located at the confluence of rivers Kumiya and Sakuni.",
    "highlight": "Confluence location.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Kapileshwar_Mahadev_Almora.jpg",
    "credit": "Wikimedia Commons",
  ...
  },
  {
    ...
    "story": "A magnificent stone temple built by the Chand rulers, known for intricate carvings.",
    "highlight": "Intricate stone carvings.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Baleshwar_Temple_Champawat.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      "history": "10-12th century.",
      "architecture": "Nagara.",
      "visitorNotes": "Architectural gem.",
      "sources": [
        {
          "label": "Baleshwar Temple",
          "url": "https://en.wikipedia.org/wiki/Baleshwar_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Hill style.",
      "visitorNotes": "Best view of town.",
      "sources": [
        {
          "label": "Champawat",
          "url": "https://en.wikipedia.org/wiki/Champawat",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Discovered 1993.",
      "architecture": "Natural cave.",
      "visitorNotes": "Spiritual spot.",
      "sources": [
        {
          "label": "Champawat",
          "url": "https://en.wikipedia.org/wiki/Champawat",
  ...
  },
  {
    ...
    "story": "Associated with the Lakshagriha (House of Wax) of Mahabharata; houses a graphite Linga that reflects faces.",
    "highlight": "Graphite Linga.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Lakhamandal_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Nagara.",
      "visitorNotes": "Check reflection in Linga.",
      "sources": [
        {
          "label": "Lakhamandal",
          "url": "https://en.wikipedia.org/wiki/Lakhamandal",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "Dedicated to Mahasu Devta (Shiva variant), the chief deity of the Jaunsar-Bawar region.",
    "highlight": "Jaunsari architecture.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Mahasu_Devta_Temple_Hanol.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      ...
      "visitorNotes": "Unique cultural zone.",
      "sources": [
        {
          "label": "Mahasu Devta Temple",
          "url": "https://en.wikipedia.org/wiki/Mahasu_Devta_Temple",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "Dedicated to Lord Balram (brother of Krishna), revered alongside Shiva on a high peak.",
    "highlight": "Views of Doon Valley.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Bhadraj_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Trekking gear.",
    "entryNotes": "Trek from Cloud's End.",
    "rituals": [
      "Milk offering"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Hill style.",
      "visitorNotes": "Moderate trek.",
      "sources": [
        {
          "label": "Mussoorie",
          "url": "https://en.wikipedia.org/wiki/Mussoorie",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  {
    "name": "Koteshwar Mahadev (Rudraprayag)",
    "state": "Uttarakhand",
    "city": "Rudraprayag",
    "region": "Rudraprayag district",
    "tags": [
    ...
    "story": "A cave temple on the banks of Alaknanda where Shiva meditated before going to Kedarnath.",
    "highlight": "Cave beside river.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Koteshwar_Mahadev_Rudraprayag.jpg",
    "credit": "Wikimedia Commons",
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "Close to Rudraprayag.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      ...
      "sources": [
        {
          "label": "Rudraprayag",
          "url": "https://en.wikipedia.org/wiki/Rudraprayag",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Nagara.",
      "visitorNotes": "Base for Kedarnath heli.",
      "sources": [
        {
          "label": "Agastyamuni",
          "url": "https://en.wikipedia.org/wiki/Agastyamuni",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "moreDetails": {
      ...
      "architecture": "Nagara.",
      "visitorNotes": "Witness the vigil.",
      "sources": [
        {
          "label": "Srinagar, Uttarakhand",
          "url": "https://en.wikipedia.org/wiki/Srinagar,_Uttarakhand",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "The guardian deity of Uttarakhand; her shrine was relocated during dam construction, causing controversy. Shiva is Guardian.",
    "highlight": "Floating temple feel.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Dhari_Devi_Temple.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      "history": "Ancient/Relocated.",
      "architecture": "Modern.",
      "visitorNotes": "Powerful vibe.",
      "sources": [
        {
          "label": "Dhari Devi",
  ...
  },
  {
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "3 km uphill from Jageshwar.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [],
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Nagara.",
      "visitorNotes": "Silence and views.",
      "sources": [
        {
          "label": "Jageshwar",
          "url": "https://en.wikipedia.org/wiki/Jageshwar",
  ...
  },
  {
    ...
    "story": "A group of 55 ancient temples (Badrinath, Maniyan, Ratan Deo, etc.) heavily influenced by Gurjara-Pratihara art.",
    "highlight": "Temple cluster architecture.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Dwarahat_temples.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      ...
      "architecture": "Nagara.",
      "visitorNotes": "Historical village.",
      "sources": [
        {
          "label": "Dwarahat",
          "url": "https://en.wikipedia.org/wiki/Dwarahat",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "story": "Believed to be the spot where a piece of the Sanjeevani mountain fell; houses a Shiva shrine.",
    "highlight": "Mountain views.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Dunagiri_Temple.jpg",
    "credit": "Wikimedia Commons",
  ...
  },
  {
    ...
    "entryNotes": "Short trek from Kedarnath.",
    "rituals": [
      "Oil offering"
    ],
    "festivals": [],
    "moreDetails": {
      ...
      "visitorNotes": "Must visit after Kedarnath.",
      "sources": [
        {
          "label": "Kedarnath",
  ...
  },
  {
    ...
    "story": "A historic Shiva shrine in the Jageshwar region, visited as part of the broader Kumaon Shaiva pilgrimage circuit.",
    "highlight": "Ancient Himalayan Shaiva shrine in the Jageshwar belt.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Vriddh_Jageshwar.jpg",
    "credit": "Wikimedia Commons",
    "creditUrl": "https://commons.wikimedia.org/wiki/File:Vriddh_Jageshwar.jpg",
    "deity": "Shiva (Mahadev)",
    "tradition": "Shaiva",
    "addedAt": "2026-02-20T11:45:00+05:30",
    "bestTime": "March to June and September to November.",
    "timings": "Not Available",
    "dressCode": "Modest attire recommended.",
    "entryNotes": "Can be combined with nearby Jageshwar temple visits.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "Vriddha Jageshwar is traditionally linked to the wider Jageshwar Shaiva heritage region in Kumaon.",
      "architecture": "Stone temple structure typical of Himalayan Kumaon shrines.",
      "visitorNotes": "Route conditions vary during monsoon; check local access before travel.",
      "sources": [
        {
          "label": "Jageshwar",
          "url": "https://en.wikipedia.org/wiki/Jageshwar",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Modern.",
      "architecture": "Modern.",
      "visitorNotes": "International followers.",
      "sources": [
        {
          "label": "Haidakhan Babaji",
          "url": "https://en.wikipedia.org/wiki/Haidakhan_Babaji",
          "type": "Encyclopedia"
        }
      ]
    }
  },
  {
    ...
    "story": "Founded by Neem Karoli Baba; houses a Shiva temple alongside Hanuman; heavily visited by tech visionaries.",
    "highlight": "Neem Karoli Baba's ashram.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Kainchi_Dham.jpg",
    "credit": "Wikimedia Commons",
    ...
    "moreDetails": {
      "history": "1960s.",
      "architecture": "Modern.",
      "visitorNotes": "Silence maintained.",
      "sources": [
        {
          "label": "Kainchi Dham",
          "url": "https://en.wikipedia.org/wiki/Kainchi_Dham",
          "type": "Encyclopedia"
        }
      ]
    }
  ...
  },
  {
    ...
    "entryNotes": "25 km from Rishikesh.",
    "rituals": [
      "Meditation"
    ],
    "festivals": [
  ...
  {
    "name": "Tadkeshwar Mahadev Temple",
    "state": "Uttarakhand",
    "city": "Pauri Garhwal",
    "region": "Pauri Garhwal district",
    "tags": [
    ...
    "story": "A Shiva shrine located inside dense cedar forest zones of Pauri Garhwal, known for quiet darshan and local devotion.",
    "highlight": "Mahadev shrine amid deodar forest belts.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/TADKESHWAR_MAHADEV-PAURI_GARHWAL-UTTARAKHAND_002.jpg",
    "credit": "Wikimedia Commons",
    "creditUrl": "https://commons.wikimedia.org/wiki/File:TADKESHWAR_MAHADEV-PAURI_GARHWAL-UTTARAKHAND_002.jpg",
    "deity": "Shiva (Mahadev)",
    "tradition": "Shaiva",
    "addedAt": "2026-02-20T11:45:00+05:30",
    "bestTime": "March to June and September to November.",
    "timings": "Not Available",
    "dressCode": "Modest attire recommended.",
    "entryNotes": "Road and final approach may vary by season.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "The shrine is regionally revered in Garhwal as a long-standing Mahadev temple.",
      "architecture": "Hill-temple layout with simple sanctum design.",
      "visitorNotes": "Carry weather-ready clothing due to forest elevation.",
      "sources": [
        {
          "label": "Pauri Garhwal District",
          "url": "https://pauri.nic.in/",
  ...
  },
  {
    ...
    "story": "A revered cave shrine associated with Shiva and multiple sacred formations, visited as an important Himalayan pilgrimage site.",
    "highlight": "Underground cave darshan with Shiva-linked sacred forms.",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Patal_Bhuvaneshwar_Cave.jpg",
    "credit": "Wikimedia Commons",
    "creditUrl": "https://commons.wikimedia.org/wiki/File:Patal_Bhuvaneshwar_Cave.jpg",
    "deity": "Shiva (Bhuvaneshwar)",
    "tradition": "Shaiva",
    "addedAt": "2026-02-20T11:45:00+05:30",
    "bestTime": "April to June and September to November.",
    "timings": "Not Available",
    "dressCode": "Modest attire; cave-friendly footwear.",
    "entryNotes": "Cave passages can be narrow and slippery.",
    "rituals": [
      "Daily puja"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "Patal Bhuvaneshwar is described as an ancient cave temple linked to Shaiva worship traditions.",
      "architecture": "Natural limestone cave with shrine installations.",
      "visitorNotes": "Exercise caution while descending cave pathways.",
      "sources": [
        {
          "label": "Patal Bhuvaneshwar",
          "url": "https://en.wikipedia.org/wiki/Patal_Bhuvaneshwar",
  ...
  {
    "name": "Chandeshwar Mahadev Temple (Haridwar)",
    "state": "Uttarakhand",
    "city": "Haridwar",
    "region": "Haridwar district",
    "tags": [
    ...
    "story": "A regional Shiva shrine in Haridwar associated with continuous Mahadev worship by local devotees and pilgrims.",
    "highlight": "Accessible Shaiva shrine within the Haridwar pilgrimage circuit.",
    "image": null,
    "credit": "",
    "creditUrl": "",
    "deity": "Shiva (Chandeshwar Mahadev)",
    "tradition": "Shaiva",
    "addedAt": "2026-02-20T11:45:00+05:30",
    "bestTime": "October to March for cooler weather.",
    "timings": "Not Available",
    "dressCode": "Modest attire recommended.",
    "entryNotes": "Confirm local darshan timings before visit.",
    "rituals": [
      "Daily puja",
      "Aarti"
    ],
    ...
    "moreDetails": {
      "history": "Haridwar has multiple neighborhood Shiva shrines including Chandeshwar Mahadev worship traditions.",
      "architecture": "Local North Indian temple style.",
      "visitorNotes": "Combine with nearby Haridwar tirth circuit visits.",
      "sources": [
        {
  ...
  {
    "name": "Mrityunjaya Temple (Jageshwar)",
    "state": "Uttarakhand",
    "city": "Jageshwar",
    "region": "Almora district",
    "tags": [
    ...
    "credit": "Wikimedia Commons",
    "creditUrl": "https://commons.wikimedia.org/wiki/File:Lord_Shiva_Mritunjaya_Temple_Jageshwar_Almora.jpg",
    "deity": "Shiva (Mahamrityunjaya)",
    "tradition": "Shaiva",
    "addedAt": "2026-02-20T11:45:00+05:30",
    "bestTime": "March to June and September to November.",
    "timings": "Not Available",
    "dressCode": "Modest attire recommended.",
    "entryNotes": "Best visited with the larger Jageshwar temple circuit.",
    "rituals": [
    ...
    "moreDetails": {
      "history": "Jageshwar valley contains multiple historic Shiva shrines including Mrityunjaya worship traditions.",
      "architecture": "Stone temple architecture typical of Kumaon Shaiva shrines.",
      "visitorNotes": "Plan a half-day circuit for nearby Jageshwar temples.",
      "sources": [
        {
          "label": "Jageshwar",
          "url": "https://en.wikipedia.org/wiki/Jageshwar",
  ...
  },
  {
    ...
    "moreDetails": {
      "history": "Ancient.",
      "architecture": "Simple.",
      "visitorNotes": "Unique astrological site.",
      "sources": [
        {
          "label": "Pauri",
          "url": "https://en.wikipedia.org/wiki/Pauri_Garhwal_district",
  ...
  },
  {
    ...
    "timings": "Open daily.",
    "dressCode": "Traditional.",
    "entryNotes": "6 km from Pithoragarh.",
    "rituals": [
      "Chariot pull"
    ],
    "festivals": [
    ...
    "moreDetails": {
      "history": "Local legend.",
      "architecture": "Hill style.",
      "visitorNotes": "Cultural extravaganza.",
      "sources": [
        {
          "label": "Pithoragarh",
          "url": "https://en.wikipedia.org/wiki/Pithoragarh",
  ...
  },
  {
    ...
    "state": "Uttarakhand",
    "image": "https://commons.wikimedia.org/wiki/Special:FilePath/Daksheshwar_Mahadev_temple%2C_Kankhal.JPG",
    "credit": "Wikimedia Commons",
    "creditUrl": "https://commons.wikimedia.org/wiki/File:Daksheshwar_Mahadev_temple,_Kankhal.JPG",
    "tradition": "Shaiva",
